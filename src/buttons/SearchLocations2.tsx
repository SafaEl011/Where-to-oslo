...
export function SearchLocations2({ showOverlay, toggleOverlay}: {showOverlay: boolean; toggleOverlay: () => void }) {
    ...
    useEffect(() => {
        const fetchFiles = async () => {
            const files = ["json/activity.geojson",
            ...
            const mergedFeatures = data.flatMap((datum: { features: SearchJson[] }) => datum.features);
